...
define([
                ...
                'views/busRouteStops',
                'views/busCountdown'], function( $, _, Backbone, 
            ...
            var initialize = function( ) {
                ...
                busRouter.on( 'route:homeRoute', function () {
                    ...
                    this.routeView = new busRoutesView({model: busRoutesCollection});
                ...
                busRouter.on( 'route:routeSelected', function (routeId) {
                    ...
                    this.directionView = new busDirectionsView({model: busDirectionsCollection});
                ...
                busRouter.on( 'route:directionSelected', function (routeId, busDirection) {
                    ...
                    this.stopsView = new busRouteStopsView({model: busStopsCollection});
                ...
                busRouter.on( 'route:stopSelected', function ( routeId, busDirection, stopId ) {
                    ...
                    this.countDownView = new busCountdownView({model: busCountdownCollection});

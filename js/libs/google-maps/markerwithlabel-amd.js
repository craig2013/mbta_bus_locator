...
(function(factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(['async!https://maps.googleapis.com/maps/api/js?key=AIzaSyCpljpAf9iuxW7gj2YZZlaS9o4e3oTBgp0'], factory);
    } else if (typeof exports === 'object') {
        // CommonJS
        module.exports = factory(require('async!https://maps.googleapis.com/maps/api/js?key=AIzaSyCpljpAf9iuxW7gj2YZZlaS9o4e3oTBgp0'));
    } else {
        // Globals
        factory(google);
    }
